/*
I'm not sure whether this can work, I can't find any official version from Microsoft.
The file is based on: 
https://learn.microsoft.com/en-us/windows/win32/api/windowsdefender/, 
https://learn.microsoft.com/zh-cn/windows/win32/lwef/windows-defender-bumper, 
https://github.com/hfiref0x/MpEnum/blob/master/Source/Takanami/MpClient.h,
https://github.com/pettro98/mpclient/,
https://github.com/r3dhun9/MpClientTracer
and my reverses and guesses.
*/
...
typedef enum tagMP_THREAT_STAT {
	MP_THREAT_STAT_MAX_VALUE = 1000
}MP_THREAT_STAT, *PMP_THREAT_STAT;
...
/*From https://github.com/r3dhun9/MpClientTracer */
...
/*Redefine such functions*/

typedef HRESULT(*WDStatus)(
	_Out_ BOOL* pfEnabled
	);

typedef HRESULT(*WDEnable)(
	_In_ BOOL fEnable
	);

typedef HRESULT(*MpWDEnable)(
	_In_ BOOL fEnable
	);
...
typedef HRESULT(WINAPI* MpManagerStatusQuery)(
	_In_  MPHANDLE       hMpHandle,
	_Out_ PMPSTATUS_INFO pStatusInfo
	);

typedef HRESULT(WINAPI* MpManagerStatusQueryEx)(
	_In_  MPHANDLE       hMpHandle,
	_In_  DWORD          dwFlag,
	_Out_ PMPSTATUS_INFO pStatusInfo
	);

typedef HRESULT(WINAPI* MpManagerVersionQuery)(
	_In_  MPHANDLE        hMpHandle,
	_Out_ PMPVERSION_INFO pVersionInfo
	);

typedef HRESULT(WINAPI* MpScanControl)(
	_In_ MPHANDLE  hScanHandle,
	_In_ MPCONTROL ScanControl
	);
...
typedef HRESULT(WINAPI* MpThreatEnumerate)(
	_In_  MPHANDLE       hThreatEnumHandle,
	_Out_ PMPTHREAT_INFO* ppThreatInfo
	);

typedef HRESULT(WINAPI* MpThreatOpen)(
	_In_  MPHANDLE        hScanHandle,
	_In_  MPTHREAT_SOURCE ThreatSource,
	_In_  MPTHREAT_TYPE   ThreatType,
	_Out_ PMPHANDLE       phThreatEnumHandle
...
typedef HRESULT(WINAPI* MpThreatQuery)(
	_In_      MPHANDLE                 hMpHandle,
	_In_      MPTHREAT_ID              ThreatID,
	_Out_     PMPTHREAT_INFO* ppThreatInfo,
	_Out_opt_ PMPTHREAT_LOCALIZED_INFO* ppThreatLocalizedInfo
...
typedef HRESULT(WINAPI* MpUpdateControl)(
	_In_ MPHANDLE  hUpdateHandle,
	_In_ MPCONTROL UpdateControl
	);

typedef HRESULT(WINAPI* MpUpdateStart)(
	_In_     MPHANDLE         hMpHandle,
	_In_     DWORD            dwUpdateOptions,
	_In_opt_ PMPCALLBACK_INFO pCallbackInfo,
	_Out_    PMPHANDLE        phUpdateHandle
